        ...
        <div className="w-full h-full flex justify-center items-center">
          <Draggable onDrag={this.eventControl} onStop={this.eventControl}>
            <div className="flex flex-col justify-center gap-2">
              {(this.state.ExpandPoint > 0) ? <button className=" flex justify-center self-center transition w-full h-19 ease-in-out hover:border-lime-400 border-2 dark:hover:border-fuchsia-400 dark:border-stone-950 border-zinc-50 rounded-t-full " onClick={() => !this.state.dragbool && this.ExpandGrid("up",true)}><ArrowUpCircleIcon onTouchStart={() => setTimeout(() => { if (!this.state.dragbool) { this.ExpandGrid("up",true) } }, 200)} className=" h-14 w-14 dark:fill-fuchsia-300 fill-lime-400 overflow-hidden "></ArrowUpCircleIcon></button> : null}
              <div className="flex flex-row justify-center gap-2">
                {(this.state.ExpandPoint > 0) ? <button className="transition w-full h-19 ease-in-out hover:border-lime-400 dark:hover:border-fuchsia-400 border-2 dark:border-stone-950 border-zinc-50 rounded " onClick={() => !this.state.dragbool && this.ExpandGrid("left",true)}><ArrowLeftCircleIcon onTouchStart={() => setTimeout(() => { if (!this.state.dragbool) { this.ExpandGrid("left",true) } }, 200)} className="  h-14 w-14 dark:fill-fuchsia-300 fill-lime-400 overflow-hidden"></ArrowLeftCircleIcon></button> : null}
                <this.MakeGrid />
                {(this.state.ExpandPoint > 0) ? <button className="transition w-full h-19 ease-in-out hover:border-lime-400 dark:hover:border-fuchsia-400 border-2 rounded dark:border-stone-950 border-zinc-50" onClick={() => !this.state.dragbool && this.ExpandGrid("right",true)}><ArrowRightCircleIcon onTouchStart={() => setTimeout(() => { if (!this.state.dragbool) { this.ExpandGrid("right",true) } }, 200)} className=" h-14 w-14 dark:fill-fuchsia-300 fill-lime-400 overflow-hidden"></ArrowRightCircleIcon></button> : null}
              </div>
              {(this.state.ExpandPoint > 0) ? <button className=" flex justify-center transition w-full h-19 ease-in-out hover:border-lime-400 dark:hover:border-fuchsia-400 border-2 rounded-b-full dark:border-stone-950 border-zinc-50" onClick={() => !this.state.dragbool && this.ExpandGrid("down",true)}><ArrowDownCircleIcon onTouchStart={() => setTimeout(() => { if (!this.state.dragbool) { this.ExpandGrid("down",true) } }, 200)} className=" dark:fill-fuchsia-300  h-14 w-14 fill-lime-400 overflow-hidden" ></ArrowDownCircleIcon></button> : null}
            </div>
          </Draggable>
        </div>
